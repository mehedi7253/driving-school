    ...
    <div class="content mt-3">
        <div class="col-md-12 mx-auto">
            <div class="card">
                ...
                $live = "SELECT date, COUNT(date) AS Live FROM track_trainer, enroll_student WHERE 
                          enroll_student.student_id = '$userdata[id]' AND 
                ...
                <div class="card-body">
                    <?php
                    $track = "SELECT * FROM track_trainer, users, package, enroll_student WHERE 
                                track_trainer.trainer_id = users.id AND
                                track_trainer.package_id = package.package_id AND 
                                track_trainer.date = '$today_date' AND 
